...
## lab 10:
## Overview
- API server,using express framework, which will provide data for the City Explorer front-end application.
...
- In 20 minutes - Application now has a fully-functional express server, with a GET route for the location resource. -->
...
## Name of feature:Building the memory

## Estimate of time needed to complete: 20 minutes

## Start time: 20 minutes
